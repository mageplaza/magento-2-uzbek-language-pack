...
![language pack](http://progressed.io/bar/10?title=translated)
...
```
unzip master.zip app/i18n/Mageplaza/uz_uz
```
...
Unzip the compressed file and upload file `uz_UZ.zip` into `app/i18n/mageplaza/uz_UZ/uz_UZ.csv`
